...
public class HttpRequestClient
    {
        ...
        public bool Upload(String requestUrl, out String responseText)
        {
            ...
            webClient.Headers.Add("Referer", "https://poem.msxiaobing.com/");
            webClient.Headers.Add("User-Agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.181 Safari/537.36");
